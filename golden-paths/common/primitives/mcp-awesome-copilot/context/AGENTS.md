...
This repository was generated from the Open Horizons `mcp-awesome-copilot` Golden Path.

**Purpose:** MCP server exposing the Copilot primitive catalog to agents.
...
| Kind | Installed |
| --- | --- |
| Agents | `compass`, `copilot-primitive-architect`, `pipeline`, `sentinel`, `typescript-mcp-expert` |
| Skills | `conventional-branch`, `copilot-primitive-authoring`, `documentation-writer`, `mcp-builder`, `mcp-cli`, `mcp-implementation-security-review`, `pipeline-diagnostics`, `review-and-refactor`, `security-review`, `story-planning`, `test-coverage` |
| Instructions | `copilot-primitive-authoring`, `devops-core-principles`, `security-and-owasp`, `self-explanatory-code-commenting`, `typescript-mcp-server` |
