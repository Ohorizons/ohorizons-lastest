...
This repository was generated from the Open Horizons `batch-job` Golden Path.

**Purpose:** Scheduled batch or cron workload with retry and observability.
...
| Kind | Installed |
| --- | --- |
| Agents | `compass`, `pipeline`, `platform-sre-kubernetes`, `sentinel` |
| Skills | `azure-kubectl-cli`, `azure-kubernetes`, `conventional-branch`, `documentation-writer`, `pipeline-diagnostics`, `review-and-refactor`, `security-review`, `story-planning`, `test-coverage` |
