...
This repository was generated from the Open Horizons `ai-evaluation-pipeline` Golden Path.

**Purpose:** Model and agent evaluation pipeline with datasets, metrics, and regression gates.
**Primary stack:** Azure AI Foundry, evaluation harnesses
...
| Kind | Installed |
| --- | --- |
| Agents | `compass`, `pipeline`, `se-responsible-ai-code`, `sentinel`, `technical-content-evaluator` |
| Skills | `agentic-eval`, `azure-ai`, `conventional-branch`, `documentation-writer`, `eval-driven-dev`, `phoenix-evals`, `pipeline-diagnostics`, `review-and-refactor`, `security-review`, `story-planning`, `test-coverage` |
| Instructions | `ai-prompt-engineering-safety-best-practices`, `devops-core-principles`, `microsoft-foundry`, `security-and-owasp`, `self-explanatory-code-commenting` |
