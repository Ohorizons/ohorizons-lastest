...
This repository was generated from the Open Horizons `mcp-gh-aw` Golden Path.

**Purpose:** MCP server exposing GitHub Agentic Workflows to agents.
...
| Instructions | `devops-core-principles`, `github-actions-ci-cd-best-practices`, `security-and-owasp`, `self-explanatory-code-commenting`, `typescript-mcp-server` |
