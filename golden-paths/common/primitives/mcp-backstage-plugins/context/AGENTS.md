...
This repository was generated from the Open Horizons `mcp-backstage-plugins` Golden Path.

**Purpose:** MCP server exposing the Backstage plugin ecosystem to agents.
...
| Instructions | `devops-core-principles`, `security-and-owasp`, `self-explanatory-code-commenting`, `typescript-mcp-server` |
