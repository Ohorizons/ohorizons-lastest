...
This repository was generated from the Open Horizons `documentation-site` Golden Path.

**Purpose:** Documentation website with TechDocs integration, search, and versioning.
...
| Kind | Installed |
| --- | --- |
| Agents | `compass`, `gem-documentation-writer`, `pipeline`, `project-documenter`, `sentinel` |
| Skills | `conventional-branch`, `convert-plaintext-to-md`, `documentation-writer`, `mkdocs-translations`, `pipeline-diagnostics`, `review-and-refactor`, `security-review`, `story-planning`, `test-coverage` |
| Instructions | `devops-core-principles`, `markdown`, `markdown-accessibility`, `markdown-content-creation`, `security-and-owasp`, `self-explanatory-code-commenting` |
| Prompts | `create-architectural-decision-record`, `create-llms` |
