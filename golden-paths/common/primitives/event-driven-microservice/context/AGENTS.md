...
This repository was generated from the Open Horizons `event-driven-microservice` Golden Path.

**Purpose:** Event-driven service consuming and publishing through a message broker.
**Primary stack:** Azure Service Bus, Event Hubs, Event Grid, Kafka
...
| Skills | `api-testing`, `azure-messaging`, `contract-testing`, `conventional-branch`, `documentation-writer`, `pipeline-diagnostics`, `review-and-refactor`, `security-review`, `story-planning`, `test-coverage` |
