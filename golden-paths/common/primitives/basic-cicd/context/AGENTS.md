...
This repository was generated from the Open Horizons `basic-cicd` Golden Path.

**Purpose:** CI/CD pipeline added to an existing repository, with build, test, lint, security scanning, and deployment stages.
