...
This repository was generated from the Open Horizons `api-microservice` Golden Path.

**Purpose:** Production REST API microservice backed by a relational database and a cache.
...
| Skills | `api-testing`, `azure-managed-redis-cache`, `azure-postgre-database-management`, `contract-testing`, `conventional-branch`, `documentation-writer`, `pipeline-diagnostics`, `review-and-refactor`, `security-review`, `story-planning`, `test-coverage` |
...
| Prompts | `create-architectural-decision-record`, `postgresql-code-review` |
