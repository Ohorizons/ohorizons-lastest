...
This repository was generated from the Open Horizons `mcp-backstage-org` Golden Path.

**Purpose:** MCP server exposing Backstage organization and repository topology to agents.
