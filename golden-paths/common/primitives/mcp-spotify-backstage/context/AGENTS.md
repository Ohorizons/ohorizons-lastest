...
This repository was generated from the Open Horizons `mcp-spotify-backstage` Golden Path.

**Purpose:** MCP server exposing upstream Spotify Backstage documentation to agents.
...
| Instructions | `devops-core-principles`, `markdown`, `security-and-owasp`, `self-explanatory-code-commenting`, `typescript-mcp-server` |
