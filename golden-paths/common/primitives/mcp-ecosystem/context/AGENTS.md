...
This repository was generated from the Open Horizons `mcp-ecosystem` Golden Path.

**Purpose:** Aggregate MCP server covering the wider Model Context Protocol ecosystem.
...
| Skills | `conventional-branch`, `documentation-writer`, `mcp-builder`, `mcp-cli`, `mcp-implementation-security-review`, `mcp-security-audit`, `pipeline-diagnostics`, `review-and-refactor`, `security-review`, `story-planning`, `test-coverage` |
