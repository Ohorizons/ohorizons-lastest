...
This repository was generated from the Open Horizons `microservice` Golden Path.

**Purpose:** Complete containerised microservice with API, observability, and GitOps deployment.
**Primary stack:** Containers, Kubernetes
...
| Kind | Installed |
| --- | --- |
| Agents | `api-architect`, `compass`, `pipeline`, `platform-sre-kubernetes`, `sentinel` |
| Skills | `api-testing`, `azure-kubernetes`, `conventional-branch`, `documentation-writer`, `multi-stage-dockerfile`, `pipeline-diagnostics`, `review-and-refactor`, `security-review`, `story-planning`, `test-coverage` |
| Instructions | `containerization-docker-best-practices`, `devops-core-principles`, `kubernetes-deployment-best-practices`, `security-and-owasp`, `self-explanatory-code-commenting` |
