...
This repository was generated from the Open Horizons `mcp-backstage-ui` Golden Path.

**Purpose:** MCP server exposing the Backstage design system to agents.
...
| Instructions | `a11y`, `devops-core-principles`, `security-and-owasp`, `self-explanatory-code-commenting`, `typescript-mcp-server` |
