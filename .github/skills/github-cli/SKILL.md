...
> [!NOTE]
> This skill shells out to the GitHub CLI (`gh`) and may use `.github/skills/github-cli/scripts/setup-github-app.sh` for GitHub App setup. Authenticate with the intended account or GitHub App token and verify repository context before mutating operations.
...
```bash
.github/skills/github-cli/scripts/setup-github-app.sh --target backstage --org <github-org>
```
