...
- Container images: pinned Open Horizons Backstage OSS distribution on GHCR by default (`ghcr.io/ohorizons/ohorizons-backstage:v7.2.6`); custom ACR only when explicitly selected
