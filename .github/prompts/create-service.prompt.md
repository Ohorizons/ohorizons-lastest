---
description: "Scaffold a new microservice using Golden Path templates with Helm, Kustomize, and CI/CD. USE FOR: create microservice, scaffold service, new service, Golden Path service, create API service."
agent: "platform"
---
