...
Enterprise validation and deployment automation should treat only `deploy/helm/argocd/` and `deploy/helm/monitoring/` as active Helm values. Non-production examples are kept under `docs/examples/` and are not part of the deployment path.
